...
Check performance of inverse-normal transformed data against categorical and regular zero-inflated data
...
p_9(x = "linmod.pval.full.data", y = "linmod.pval.zero.inflated")
p_9(x = "linmod.pval.full.data", y = "linmod.pval.zero.inflated.transformed")

p_8(x = "linmod.pval.zero.inflated", y = "linmod.pval.zero.inflated.transformed")
p_9(x = "linmod.pval.zero.inflated", y = "linmod.pval.zero.inflated.transformed")

q_4(x = "logit.pval", y = "linmod.pval.zero.inflated.transformed")

p_8(x = "spearman.cor.pval.zero.inflated", y = "linmod.pval.zero.inflated.transformed")
p_9(x = "spearman.cor.pval.zero.inflated", y = "linmod.pval.zero.inflated.transformed")

# effect sizes
p_8(x = "linmod.beta.zero.inflated.transformed", y = "logit.beta")
p_8(x = "linmod.beta.zero.inflated.transformed", y = "linmod.beta.zero.inflated") +
  xlim(c(0,0.4)) +
  ylim(c(0,0.4)) +
  ...
  ggtitle(label = "Beta comparison",
          subtitle = "zero-inflated data ~ zero-inflated transformed data")
...
p_8(x = "linmod.beta.zero.inflated.transformed", y = "linmod.beta.full.data") +
  ...
  geom_hline(yintercept = c(0,0.01,0.02,0.05,0.1,0.3)) +
  ggtitle(label = "Beta comparison",
          subtitle = "Full data ~ zero-inflated transformed data")
...
# pvalues based on batch.effect
ggplot(test.1[categart == "bereiche" & categnum == 20,], aes(-log10(linmod.pval.zero.inflated),
                                                             -log10(linmod.pval.zero.inflated.transformed),
                                                             col = factor(proz0),
                                                             pch = factor(batch.effect))) +
  geom_point() +
  facet_wrap(~effekt, scales = "free") +
...
ggplot(test.1[categart == "bereiche",], aes(-log10(linmod.pval.full.data),
                                            -log10(linmod.pval.zero.inflated.transformed),
                                            col = factor(categnum),
                                            pch = factor(batch.effect),
                                            size = proz0,
...
p10 <- ggplot(test.1[categart == "bereiche" & categnum == 20, ],
              aes(x = -log10(p.ANOVA.full.post.ComBat),
                  y = -log10(p.ANOVA.zero.infl.post.ComBat),
                  col = factor(proz0),
                  pch = factor(batch.effect),
                  size = batch.effect)) + 
  geom_point() +
  ylab("p.ANOVA.zero.infl.post.ComBat") +
  xlab("p.ANOVA.full.post.ComBat") +
  geom_abline(intercept = 0, slope = 1, lty = 2) +
  scale_color_brewer(palette="Set1") + 
...
p11 <- ggplot(test.1[categart == "bereiche" & categnum == 20, ],
              aes(x = -log10(p.ANOVA.full.pre.ComBat),
                  y = -log10(p.ANOVA.zero.infl.pre.ComBat),
                  col = factor(proz0),
                  pch = factor(batch.effect),
                  size = batch.effect)) + 
  geom_point() +
  ylab("p.ANOVA.zero.infl.pre.ComBat") +
  xlab("p.ANOVA.full.pre.ComBat") +
  geom_abline(intercept = 0, slope = 1, lty = 2) +
  scale_color_brewer(palette="Set1") + 
  scale_size(range = c(2, 4)) +
  facet_wrap(~effekt , scales = "free") + 
