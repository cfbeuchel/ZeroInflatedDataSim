...
# also display results based on whether a batch effect was added or not
melt.1 <- melt(test.1, id.vars = c("effekt", "proz0", "categart", "categnum", "batch.effect"))
ggplot(test.1, aes())

# pvalues based on batch.effect
ggplot(test.1[categart == "bereiche",], aes(-log10(linmod.pval.zero.inflated),
